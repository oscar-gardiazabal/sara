    ...
    $.fn.asHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton) {
        ...
        if ($videoObj.get(0).volume ===
            ...
            $videoVolumeButton.css({display: "block", position: "absolute", top: 0, left: 0, width: BUTTON_SIZE + "px", height: BUTTON_SIZE + "px", cursor: "pointer", "background-image": "url('" + skinFolder + "html5boxplayer_volume.png" +
                        "')", "background-position": "top " + ($videoObj.get(0).volume > 0 ? "left" : "right")}).hover(function() {
                var backgroundPosX = $(this).css("background-position") ? $(this).css("background-position").split(" ")[0] : $(this).css("background-position-x");
                $(this).css({"background-position": backgroundPosX + " bottom"})
            }, function() {
                var backgroundPosX = $(this).css("background-position") ? $(this).css("background-position").split(" ")[0] : $(this).css("background-position-x");
            ...
            $videoVolumeBar.css({display: "none",
        ...
        var onVideoProgress = function() {
            if ($videoObj.get(0).buffered && $videoObj.get(0).buffered.length > 0 && !isNaN($videoObj.get(0).buffered.end(0)) && !isNaN($videoObj.get(0).duration)) {
                var sliderW = $videoSeeker.width();
                $videoSeekerBuffer.css({width: Math.round(sliderW *
    ...
    $.fn.wonderpluginslider = function(options) {
        ...
        AmazingSlider.prototype = {initData: function(onSuccess) {
                ...
                if (instance.options.showtimer)
                    $(".amazingslider-timer-" + instance.id, instance.container).css({display: "block", position: "absolute", left: "0px", top: instance.options.timerposition == "bottom" ? "" : "0px", bottom: instance.options.timerposition ==
            ...
            playVimeoVideo: function(href, autoplay) {
                ...
                if (ASYouTubeIframeAPIReady && !ASPlatforms.isIE6() && !ASPlatforms.isIE7() && !ASPlatforms.isIOS() && !ASPlatforms.isAndroid()) {
                    ...
                    new YT.Player("amazingslider-video-" + this.id, {width: instance.options.width, height: instance.options.height, videoId: id, playerVars: params, events: {"onReady": function(event) {
                ...
                this.container.bind("amazingslider.switchtext", function(event, prev, cur) {
                    $("head").find("style").each(function() {
                        if ($(this).data("creator") == "wonderpluginslidercreator" + instance.id && $(this).data("csstype") == "texteffect")
                            $(this).remove()
                    });
                    var textHeadCss =
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        if (!instance.textoptions.textautohide)
                            ...
                            $textBoxWrapper.css({display: instance.textoptions.textautohide ? "none" : "block"});
                        ...
                        switch (instance.textoptions.textpositionstatic) {
                            ...
                            case "topoutside":
                                ...
                                break;
                            case "bottomoutside":
                                $textWrapper.css({left: "0px", top: "100%", "margin-top": instance.textoptions.textpositionmarginstatic +
                                            "px"});
                                break
                        }
                    } else {
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        if (instance.elemArray[cur][ELEM_DESCRIPTION].length > 0)
                            ...
                            $description.css({"display": "none"}).html("");
                                ...
                                switch (effect) {
                                    ...
                                    case "slide":
                                        ...
                                        if (effect_dir == "left") {
                                            ...
                                            $textBox.delay(instance.textoptions.texteffectdelay).animate({left: "0px",
                                                opacity: 1}, instance.textoptions.texteffectduration, instance.textoptions.texteffecteasing)
                                            ...
                                            $textBox.delay(instance.textoptions.texteffectdelay).animate({top: "0px",
                                                opacity: 1}, instance.textoptions.texteffectduration, instance.textoptions.texteffecteasing)
                                    ...
                                    switch (effect1) {
                                        ...
                                        case "slide":
                                            ...
                                            if (effect_dir1 == "left") {
                                                ...
                                                $textBox1.css({left: instance.textoptions.texteffectslidedistance1 + "px", opacity: 0});
                                                $textBox1.delay(instance.textoptions.texteffectdelay1).animate({left: "0px",
                                                    opacity: 1}, instance.textoptions.texteffectduration1, instance.textoptions.texteffecteasing1)
                                                ...
                                                $textBox1.css({top: instance.textoptions.texteffectslidedistance1 + "px", opacity: 0});
                                                $textBox1.delay(instance.textoptions.texteffectdelay1).animate({top: "0px",
                                                    opacity: 1}, instance.textoptions.texteffectduration1, instance.textoptions.texteffecteasing1)
                                            }
                                            break;
                                        default:
                                    ...
                                    switch (effect2) {
                                        ...
                                        case "slide":
                                            ...
                                            if (effect_dir2 == "left") {
                                                ...
                                                $textBox2.delay(instance.textoptions.texteffectdelay2).animate({left: "0px",
                                                    opacity: 1}, instance.textoptions.texteffectduration2, instance.textoptions.texteffecteasing2)
                                                ...
                                                $textBox2.delay(instance.textoptions.texteffectdelay2).animate({top: "0px",
                                                    opacity: 1}, instance.textoptions.texteffectduration2, instance.textoptions.texteffecteasing2)
            ...
            resizeFullscreenImage: function($imgElem) {
                ...
                if (Math.abs(this.curImageMarginLeft) > 0)
                    $imgElem.css({"max-width": this.curImageMaxWidth + "%", "width": this.curImageMaxWidth + "%", "height": "100%", "margin-left": this.curImageMarginLeft + "%", "margin-top": 0});
                else
                    $imgElem.css({"max-width": this.curImageMaxWidth + "%", "width": this.curImageMaxWidth +
                ...
                if (this.options.customcss && this.options.customcss.length > 0)
                    $("head").append("<style type='text/css' data-creator='wonderpluginslidercreator" + this.id + "'>" + this.options.customcss + "</style>")
                ...
                $leftArrow.css({overflow: "hidden", position: "absolute", cursor: "pointer", width: this.options.arrowwidth + "px", height: this.options.arrowheight + "px", left: this.options.arrowmargin + "px", top: this.options.arrowtop + "%", "margin-top": "-" + this.options.arrowheight / 2 + "px", background: "url('" + this.options.arrowimage + "') no-repeat left top"});
                ...
                if (ASPlatforms.isIE678())
                    $rightArrow.css({opacity: "inherit",
                        filter: "inherit"});
                ...
                if (this.options.navdirection == "vertical") {
                    if (l == 0) {
                        $(".amazingslider-car-left-arrow-" + this.id, this.container).css({"background-position": "left bottom",
                            cursor: ""});
                    ...
                    if (l == 0) {
                        ...
                        $(".amazingslider-car-left-arrow-" + this.id, this.container).css({"background-position": "left top",
                            cursor: "pointer"});
                        $(".amazingslider-car-left-arrow-" + this.id, this.container).data("disabled", false)
                    }
                    if (l == $navContainer.width() - $bulletWrapper.width()) {
                ...
                switch (this.options.navposition) {
                    case "top":
                        ...
                        break;
                    case "topleft":
                        $bulletWrapper.css({"height": bulletSize +
                                    "px"});
                    ...
                    case "bottomright":
                        ...
                        break;
                    case "left":
                        $bulletWrapper.css({"width": bulletSize +
                                    "px"});
                        ...
                        if (instance.options.navthumbnavigationstyle == "arrow") {
                            ...
                            if (instance.options.navdirection == "horizontal")
                                if (instance.options.navmultirows) {
                                    ...
                                    $navContainer.css({width: "100%", "margin-left": m +
                                                "px"})
                                } else {
                            ...
                            $navContainer.css({"margin-left": "0px", "margin-right": "0px"});
                        else
                            $navContainer.css({"margin-top": "0px",
                                "margin-bottom": "0px"});
                        var $carLeftArrow = $("<div class='amazingslider-car-left-arrow-" + instance.id + "' style='display:none;'></div>");
                        var $carRightArrow = $("<div class='amazingslider-car-right-arrow-" + instance.id + "' style='display:none;'></div>");
                        $nav.append($carLeftArrow);
                        $nav.append($carRightArrow);
                        $carLeftArrow.css({overflow: "hidden", position: "absolute", cursor: "pointer", display: "none", width: instance.options.navthumbnavigationarrowimagewidth + "px", height: instance.options.navthumbnavigationarrowimageheight +
                ...
                if (this.options.navshowbuttons) {
                    ...
                    if (this.options.navshowarrow) {
                        ...
                        if (this.options.navarrowimage)
                            $navLeft.css({"background-image": "url('" +
                    ...
                    if (this.options.navshowplaypause) {
                        ...
                        if (this.options.navbuttonradius)
                            $navPlay.css(ASPlatforms.applyBrowserStyles({"border-radius": this.options.navbuttonradius +
                                        "px"}));
                        if (this.options.navbuttoncolor)
                        ...
                        if (this.options.navbuttonradius)
                            $navPause.css(ASPlatforms.applyBrowserStyles({"border-radius": this.options.navbuttonradius +
                                        "px"}));
                        if (this.options.navbuttoncolor)
                    ...
                    if (this.options.navshowarrow) {
                        ...
                        if (this.options.navarrowimage)
                            $navRight.css({"background-image": "url('" + this.options.skinsfolder + this.options.navarrowimage +
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    if (this.options.navbuttonshowbgimage && this.options.navbuttonbgimage)
                        $bullet.css({background: "url('" + this.options.skinsfolder + this.options.navbuttonbgimage + "') no-repeat center top"});
                    $.fn["bulletNormal" + this.id] = function() {
                    ...
                    $.fn["bulletNormal" + this.id] = function() {
                        ...
                        if (instance.options.navbordercolor)
                            $(this).css({"background-color": instance.options.navbordercolor})
                    };
                    $.fn["bulletHighlight" + this.id] = function() {
                        $(this).css({opacity: 1, filter: "alpha(opacity=100)"});
                        if (instance.options.navborderhighlightcolor)
                            $(this).css({"background-color": instance.options.navborderhighlightcolor})
                    };
            ...
            showImage: function(slideDirection) {
                ...
                $(imgLoader).load(function() {
                    ...
                    $box.amazingsliderTransition(instance.id, $imgPrev, $imgCur, {effect: transitioneffect, direction: slideDirection, duration: instance.options.transitionduration, easing: instance.options.transitioneasing, imgmarginleft: instance.curImageMarginLeft, imgmargintop: instance.curImageMarginTop, imgmaxwidth: instance.curImageMaxWidth,
                        crossfade: instance.options.crossfade, fade: instance.options.fade, slide: instance.options.slide, elastic: instance.options.elastic, slice: instance.options.slice, blinds: instance.options.blinds, threed: instance.options.threed, threedhorizontal: instance.options.threedhorizontal, blocks: instance.options.blocks, shuffle: instance.options.shuffle}, function() {
                        instance.isAnimating = false;
        ...
        this.each(function() {
            ...
            if ($(this).data("textformat") && typeof WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS !== "undefined")
                if ($(this).data("textformat")in WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS)
                    this.options = $.extend({}, WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS[$(this).data("textformat")], this.options);
            if ($(this).data("skin") && typeof WONDERPLUGIN_SLIDER_SKIN_OPTIONS !== "undefined")
                if ($(this).data("skin")in
                        WONDERPLUGIN_SLIDER_SKIN_OPTIONS)
                    this.options = $.extend({}, WONDERPLUGIN_SLIDER_SKIN_OPTIONS[$(this).data("skin")], this.options);
            var instance = this;
            ...
            var defaultOptions = {watermarklinkdefault: "http://www.wonderplugin.com/wordpress-slider/", watermarktargetdefault: "_blank", previewmode: false, isresponsive: true, isfullscreen: false, autoplay: false, pauseonmouseover: true, slideinterval: 5E3, randomplay: false, loop: 0, nativehtml5controls: false, lightboxbarheight: 48, lightboxresponsive: true, lightboxshowtitle: true, lightboxshowdescription: false,
                ...
                wimagedefault: "", wposcss: "display:block;position:absolute;top:6px;left:6px;visibility:visible;", wtextcssdefault: "font:12px Arial,Tahoma,Helvetica,sans-serif;color:#666;padding:2px 4px;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;background-color:#fff;opacity:0.9;filter:alpha(opacity=90);", winkcssdefault: "text-decoration:none;font:12px Arial,Tahoma,Helvetica,sans-serif;color:#333;"};
            var defaultTextOptions = {textstyle: "static", textpositionstatic: "bottom", textautohide: false, textpositionmarginstatic: 0,
